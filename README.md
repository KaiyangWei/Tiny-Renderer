...
## AI Usage
- I used AI as an assistant for about **20% - 30%** of the work.
...
- Source code is in the repo root (like `main.cpp`, `geometry.h`, `our_gl.*`, `model.*`).
- Assets are in the repo root for now (`african_head.obj`, `african_head_diffuse.tga`).
